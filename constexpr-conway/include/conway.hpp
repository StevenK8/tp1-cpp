...
template <size_t M, size_t N> std::string print(grid_t<M, N> const &grid) {
  std::string str;
...
template <size_t M, size_t N>
 cell_state_t inner_conway(const grid_t<M, N> &grid,
                                                  size_t i, size_t j) {
...
template <size_t M, size_t N>
 cell_state_t outer_conway(const grid_t<M, N> &grid,
                                                  size_t i, size_t j) {
...
template <size_t M, size_t N>
 grid_t<M, N> conway(grid_t<M, N> const &grid) {
  grid_t<M, N> new_grid;
...
/*
template <auto grid_a, auto grid_b> constexpr bool b_follows_a() {
